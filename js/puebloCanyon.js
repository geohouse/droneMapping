...
var map = L.map('map').setView([35.890771,-106.308691],19);
...
function createTileLayerURL(tileTypeSelection){
    ...
    let tileLayerURL = "https://geohouse.github.io/droneMapping/mapTiles/PuebloCanyon_032822/" + tileTypeSelection + "/{z}/{x}/{-y}.png";
    return tileLayerURL;
}
