...
var map = L.map('map').setView([39.589000,-106.108000],19);
...
function createTileLayerURL(tileTypeSelection){
    ...
    let tileLayerURL = "https://geohouse.github.io/droneMapping/mapTiles/WhiteRiverNationalForest_060922/" + tileTypeSelection + "/{z}/{x}/{-y}.png";
    return tileLayerURL;
}
